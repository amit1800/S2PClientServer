...
async def run_offer():
    ...
    #     #local_video = MediaPlayer(sys.argv[i]).video
    ...
    transceiver2 = pc.addTransceiver(trackOrKind="video", direction="sendonly")
    transceiver2.direction = "sendonly"
    print(sys.argv[1])
    local_video2 = MediaPlayer(sys.argv[1]).video
    transceiver2.sender.replaceTrack(local_video2)
    ...
    data = msg
    fullData = {"offer": data, "username": "amitpatange", "password": "password", "nTracks": nTracks}
